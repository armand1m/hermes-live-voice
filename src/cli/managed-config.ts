...
export const MANAGED_CONFIG_KEYS = [
  ...
  "HERMES_LIVE_HERMES_CHAT_TIMEOUT_MS",
  "HERMES_LIVE_HERMES_STREAM_IDLE_TIMEOUT_MS",
  "HERMES_LIVE_HERMES_TIMEOUT_MS",
  "HERMES_LIVE_HOST",
  "HERMES_LIVE_LAYA_SHADOW_ENABLED",
  "HERMES_LIVE_LAYA_TIMEOUT_MS",
  "HERMES_LIVE_LAYA_MOOD_STEERING",
  "HERMES_LIVE_LAYA_URL",
  ...
  "HERMES_LIVE_RIVA_ASR_URL",
  "HERMES_LIVE_RIVA_TTS_URL",
  "HERMES_LIVE_RIVA_BRAIN_URL",
  "HERMES_LIVE_RIVA_BRAIN_MODEL",
  "HERMES_LIVE_RIVA_BRAIN_API_KEY",
  "HERMES_LIVE_RIVA_MINT_API_KEY",
  "HERMES_LIVE_RIVA_VOICE",
  "HERMES_LIVE_RIVA_WS_KEEPALIVE_MS",
  "HERMES_LIVE_RIVA_BRAIN_MAX_TOKENS",
  "HERMES_LIVE_RIVA_BRAIN_REASONING_EFFORT",
  "HERMES_LIVE_RIVA_ECHO_GUARD",
  "HERMES_LIVE_RIVA_ASR_WORD_BOOST",
  "HERMES_LIVE_RIVA_ASR_WORD_BOOST_SCORE",
  "HERMES_LIVE_RIVA_BRAIN_STREAMING",
  "HERMES_LIVE_RIVA_BRAIN_THINKING",
  "HERMES_LIVE_RIVA_BRAIN_PREWARM",
  "HERMES_LIVE_KNOWLEDGE_INDEX",
  "HERMES_LIVE_KNOWLEDGE_TURN_CONTEXT",
  "HERMES_LIVE_KNOWLEDGE_REFLECTION",
  "HERMES_LIVE_VAD_RECORDING",
  "HERMES_LIVE_VAD_RECORDING_MAX_MB",
  "HERMES_LIVE_VAD_RECORDING_RETENTION_DAYS",
  "HERMES_LIVE_EXTERNAL_WORK_ENABLED",
  "HERMES_LIVE_PROGRESS_ANNOUNCEMENTS",
  "HERMES_LIVE_HERDR_EXECUTABLE",
  "HERMES_LIVE_MSSH_EXECUTABLE",
  "HERMES_LIVE_DELEGATION_AGENTS",
  ...
  "HERMES_LIVE_TTS_MAX_CHARS",
  "HERMES_LIVE_TTS_TIMEOUT_MS",
  "HERMES_LIVE_TTS_URL",
  "HERMES_LIVE_NARRATOR_URL",
  "HERMES_LIVE_NARRATOR_MODEL",
  "HERMES_LIVE_NARRATOR_TIMEOUT_MS",
  "HERMES_LIVE_ASYNC_TOOLS_ENABLED",
  "HERMES_LIVE_ANNOUNCE_MAX_DELAY_MS",
  "HERMES_LIVE_DEFERRED_ANSWER_MAX_DELAY_MS",
  "HERMES_LIVE_WS_KEEPALIVE_MS",
  "HERMES_LIVE_HALF_DUPLEX",
  "HERMES_LIVE_TURN_TAIL_MS",
  "HERMES_LIVE_FILLER_ENABLED",
  "HERMES_LIVE_FILLER_DELAY_MS",
  "HERMES_LIVE_FILLER_INTERVAL_MS",
  "HERMES_LIVE_FILLER_MAX_PER_TOOL",
  "HERMES_LIVE_FILLER_DIR",
  ...
  "OPENAI_REALTIME_INPUT_TRANSCRIPTION_LANGUAGE",
